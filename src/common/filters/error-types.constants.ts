...
export const SEAT_ALREADY_HELD = buildErrorType(
  "seat-already-held",
  "Seat Already Held",
  HttpStatus.CONFLICT,
);
...
export const HOLD_EXPIRED = buildErrorType(
  "hold-expired",
  "Hold Expired",
  HttpStatus.GONE,
);
...
export const PAYMENT_REQUIRED = buildErrorType(
  "payment-required",
  "Payment Required",
...
export const FLIGHT_NOT_FOUND = buildErrorType(
  "flight-not-found",
  "Flight Not Found",
...
export const SEAT_NOT_FOUND = buildErrorType(
  "seat-not-found",
  "Seat Not Found",
  HttpStatus.NOT_FOUND,
);
...
export const CHECKIN_NOT_FOUND = buildErrorType(
  "checkin-not-found",
  "Check-In Not Found",
  HttpStatus.NOT_FOUND,
);
...
export const ALREADY_CHECKED_IN = buildErrorType(
  "already-checked-in",
  "Already Checked In",
  HttpStatus.CONFLICT,
);
...
export const ALREADY_ON_WAITLIST = buildErrorType(
  "already-on-waitlist",
  "Already On Waitlist",
  HttpStatus.CONFLICT,
);

/** The requested waitlist entry was not found. */
export const WAITLIST_NOT_FOUND = buildErrorType(
  "waitlist-not-found",
...
export const CANCELLATION_NOT_ALLOWED = buildErrorType(
...
export const RATE_LIMIT_EXCEEDED = buildErrorType(
  "rate-limit-exceeded",
  "Rate Limit Exceeded",
...
export const UNAUTHORIZED = buildErrorType(
  "unauthorized",
  "Unauthorized",
...
/** Generic bad request. */
export const BAD_REQUEST = buildErrorType(
  "bad-request",
  "Bad Request",
...
export const INTERNAL_ERROR = buildErrorType(
  "internal-error",
...
export const STATUS_ERROR_TYPE_MAP: Readonly<Record<number, ErrorType>> = {
  ...
  [HttpStatus.NOT_FOUND]: buildErrorType(
    "not-found",
    "Not Found",
    HttpStatus.NOT_FOUND,
  ),
  [HttpStatus.CONFLICT]: buildErrorType(
    "conflict",
    "Conflict",
    HttpStatus.CONFLICT,
  ),
